...
namespace ADS.States.Menu
{
    public class MenuOption
    {
        ...
        private Vector2 _screenCenter = Locator.Instance.getService<CameraManager>().getWorldPosition(new Vector2(Game1.Instance.graphics.PreferredBackBufferWidth / 2, Game1.Instance.graphics.PreferredBackBufferHeight / 2));
